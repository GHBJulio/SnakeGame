...
public class  ImageUtil {
	...
	/**
	 * Retrieves the mapping of image names to Image objects stored in the
	 * ImageUtil class. This method provides access to the collection of images
	 * available for use within the application.
	 *
	 * @return A Map containing image names as keys and corresponding Image
	 *         objects as values.
	 */
